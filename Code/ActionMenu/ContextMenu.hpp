...
{
private:
	ContextMenu* m_contextMenu{ getGui<AvoExplorer>()->getContextMenu() };
...
public:
	...
	{
		((ActionMenu*)m_contextMenu)->actionMenuItemChoiceListeners += AvoGUI::bind(&ContextView::handleContextMenuItemChoice, this);
	}
